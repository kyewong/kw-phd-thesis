...
In our sketching-based modeling system, the sketching function
...
$zn_i$, the curves might be split into segments such as the segments
...
In the next three sections, we show how to create sub-surfaces in
