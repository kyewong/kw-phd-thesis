...
As introduced in Section~\ref{ch2:sec:sbim:sketch},
...
With the up-to-date model available and the current sketching plane,
...
\begin{figure} [htbp]
  ...
  \subfigure[]{
   ...
   \subfigure[]{
    ...
    \end{minipage}}
  \caption{Some sculpting examples.
  (a) A user sketched contour (yellow) and the generated initial model.
  (b) Tunneling operation.
  (c) Extrusion operation.
  (d) Cutting operation.
  (e) Smoothing operation.}
  \label{fig:sculpt} %% label for entire figure
\end{figure}

Next we introduce the types of strokes our system accepts and
...
Since the two curves are both planar, it can be further simplified
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%added in thesis only
That is, we first filter the shadow curve and resample it
...
\begin{figure*} [htbp]
  ...
  \subfigure[Sculpture]{
    ...
    \end{minipage}}
  \caption{Sketching of some models using our system.}
...
\begin{figure*} [htbp]
  ...
  \subfigure[Chair]{
    ...
    \end{minipage}}
  \caption{Sketching and sculpting of some models using our system.}
  \label{fig:models:combine} %% label for entire figure
\end{figure*}

Our sketch-based modeling is implemented using C++. The experiments
