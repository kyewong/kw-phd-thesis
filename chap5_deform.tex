...
\begin{figure} [htbp]
  ...
  \subfigure[]{
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.23]{figs/f5.5.original_pc-2.eps}
    \end{minipage}}
   \\
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.23]{figs/f5.5.ver0-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.23]{figs/f5.5.ver05-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.23]{figs/f5.5.ver10-3.eps}
    \end{minipage}}
  \\
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.23]{figs/f5.5.edge0-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.23]{figs/f5.5.edge05-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.23]{figs/f5.5.edge10-3.eps}
    \end{minipage}}
