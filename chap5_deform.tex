...
\begin{figure} [htbp]
  ...
  \subfigure[]{
    ...
    \begin{minipage}[b]{0.3\textwidth}
      \centering
      \includegraphics[scale=0.33]{figs/f5.1.baby-pc-3.eps}
    \end{minipage}}
   \\
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.3\textwidth}
      \centering
      \includegraphics[scale=0.33]{figs/f5.1.ver0-iso-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.3\textwidth}
      \centering
      \includegraphics[scale=0.33]{figs/f5.1.ver05-iso-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.3\textwidth}
      \centering
      \includegraphics[scale=0.33]{figs/f5.1.ver10-iso-3.eps}
    \end{minipage}}
  \\
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.3\textwidth}
      \centering
      \includegraphics[scale=0.33]{figs/f5.1.edge0-iso-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.3\textwidth}
      \centering
      \includegraphics[scale=0.33]{figs/f5.1.edge05-iso-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
...
\begin{figure} [htbp]
  ...
  \subfigure[]{
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.31]{figs/f5.5.original_pc-2.eps}
    \end{minipage}}
   \\
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.31]{figs/f5.5.ver0-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.31]{figs/f5.5.ver05-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.31]{figs/f5.5.ver10-3.eps}
    \end{minipage}}
  \\
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.31]{figs/f5.5.edge0-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.31]{figs/f5.5.edge05-3.eps}
    \end{minipage}}
  \subfigure[]{
    \centering
    ...
    \begin{minipage}[b]{0.32\textwidth}
      \centering
      \includegraphics[scale=0.31]{figs/f5.5.edge10-3.eps}
    \end{minipage}}
